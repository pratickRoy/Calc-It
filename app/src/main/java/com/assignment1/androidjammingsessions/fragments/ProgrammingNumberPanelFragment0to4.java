...
public class ProgrammingNumberPanelFragment0to4 extends Fragment
{
    ...
    //
        ...
        ProgrammingNumberPanelFragment0to4Listener mCallback;
    //


        public interface ProgrammingNumberPanelFragment0to4Listener
        {
    ...
    //
        ...
        public void onAttach(Activity activity)
        {
            ...
            //
                    ...
                    try
                    {
                        mCallback = (ProgrammingNumberPanelFragment0to4Listener) activity;
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
        {
                ...
                rootView= inflater.inflate(R.layout.layout_fragment__programming_number_panel_0to4, container, false);
